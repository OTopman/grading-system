...
<head>
    ...
    <link rel="stylesheet" href="{{url('asset/admin/bower_components/fullcalendar/dist/fullcalendar.min.css')}}">
    <link rel="stylesheet" href="{{url('asset/admin/bower_components/fullcalendar/dist/fullcalendar.print.min.css')}}" media="print">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{url('asset/admin/dist/css/AdminLTE.min.css')}}">
    <link rel="stylesheet" href="{{url('asset/admin/plugins/pace/pace.min.css')}}">
    <link rel="stylesheet" href="{{url('asset/admin/dist/css/bootstrap-datepicker.min.css')}}">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{image_url('a.jpeg')}}" class="user-image" alt="User Image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="{{image_url( 'a.jpeg')}}" style="width: 40px; height: 40px;" class="img-circle" alt="User Image">
                </div>
...
<script src="{{url('asset/admin/dist/js/bootstrap-datepicker.min.js')}}"></script>
<!-- Morris.js charts -->
