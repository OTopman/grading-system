...
public class Developer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String JSON_FILE = "{'error' : '1', " +
            "'0' : {'matric' : 'cs201702156pt', 'name' : 'Badiru musiliu Adedeji', 'level' : 'ND 2 FT'}, " +
            "'1' : {'matric' : 'cs201700493pt', name : 'Ojo TIMILEYIN oladayo', 'level' : 'ND 2 FT'}, " +
            "'2' : {'matric' : 'cs201703969pt', name : 'Kasali Kehinde Abdulkabir', 'level' : 'ND 2 FT'}}";
